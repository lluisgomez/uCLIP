...
if __name__ == '__main__':
    ...
    metrics_rejection, metrics_calibration, oracle_metrics_rejection = eval_single("ViT-L-14", dataloader, device, method='top1similarity')
    print_metrics(metrics_rejection)
    with open('results/metrics_rejection_flickr_single_top1similarity.json', 'w') as f:
        json.dump(metrics_rejection, f)
    with open('results/metrics_calibration_flickr_single_top1similarity.json', 'w') as f:
